...
class Error:
    ...
    def as_string(self):
        ...
        result += "\n\n" + stwing_with_awwows(self.pos_start.ftxt, self.pos_start, self.pos_end)
        return result
...
class Parser:
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expected 'WETURN', 'CONTINUWU', 'BWEAK', 'oichan', 'IF', 'FOR', 'WHILE', 'FUNCTION', int, float, identifier, '+', '-', '(', '[' or 'NOT'",
                )
            )
    ...
    def expr(self):
        ...
        if self.current_tok.matches(TT_KEYWORD, "onichan"):
            res.register_advancement()
            self.advance()
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expwected 'onichan', 'IF', 'FOR', 'WHILE', 'FUNCTION', int, float, identifier, '+', '-', '(', '[' or 'NOT'",
                )
            )
        ...
        if res.error:
            return res.failure(
                InvalidSyntaxError(
                    self.current_tok.pos_start,
                    self.current_tok.pos_end,
                    "Expwected int, float, identifier, '+', '-', '(', '[', 'IF', 'FOR', 'WHILE', 'FUNCTION' or 'NOT'",
                )
            )
    ...
    def atom(self):
        ...
        return res.failure(
            InvalidSyntaxError(
                tok.pos_start,
                tok.pos_end,
                "Expwected int, float, identifier, '+', '-', '(', '[', IF', 'FOR', 'WHILE', 'FUNCTION'",
            )
        )
...
global_symbol_table.set("math_pwi", Number.math_PI)
